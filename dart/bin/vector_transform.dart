...
class NonSIMDVectorTransformBenchmark extends BenchmarkBase {
  const NonSIMDVectorTransformBenchmark() : super("NonSIMDVectorTransform");
  final Float32List A = new Float32List(16);
  final Float32List B = new Float32List(4);
  final Float32List C = new Float32List(4);

  static void main() {
    new NonSIMDVectorTransformBenchmark().report();
  }
...
class VectorTransformBenchmark {
  static Object create() {
    return new BenchmarkContrast("VectorTransform",
                                 new NonSIMDVectorTransformBenchmark(),
                                 new SIMDVectorTransformBenchmark());
  }
}
